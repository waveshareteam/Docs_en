...
sidebar_position: 5
title: Product FAQ
slug: /ESP32-C6-Touch-AMOLED-1.43/FAQ
product_family:
  - ESP32
product_model:
...
<Details 
  ...
  - Check if the Arduino IDE -> Tools is properly configured.
    ![Arduino Configuration](./images/ESP32-C6-Touch-AMOLED-1.43-ArduinoToolCfg.webp)
</Details>
...
<Details 
  summary=" Q: How to choose a lithium battery?" 
  className="faq-details" open>
