...
slug: /ESP32-C6-Touch-AMOLED-1.43/Development-Environment-Setup-Arduino
product_family:
  - ESP32
product_model:
...
- The sample program package for the ESP32-C6-Touch-AMOLED-1.43 development board can be downloaded from [here](./Resources-And-Documents.md#Demo). The <code>Arduino\libraries</code> directory within the package already includes all the library files required for this tutorial.
...
<div 
  style={{maxWidth:600}}> 
  ![](./images/ESP32-C6-Touch-AMOLED-1.43-ArduinoToolCfg.webp)
</div>
...
- The display cycles through red, green, and blue colors (transition interval 1.5 seconds), as shown:
  ...
  <div style={{maxWidth: 1200}}>
    ![](./images/Arduino-Example-11-1.webp)
  </div>
...
- After the system finishes displaying the above colors, it will automatically enter the onboard hardware information interface, as shown in the figure:
  ...
  <div style={{maxWidth: 400}}>
    ![](./images/Arduino-Example-11-2.webp)
  </div>
...
- Click the BOOT button on the onboard hardware information interface to enter the Touch function interface, as shown:
  ...
  <div style={{maxWidth: 400}}>
    ![](./images/Arduino-Example-11-3.webp)
  </div>
...
- Test the TF card read/write function, as shown:
  ...
  <div style={{maxWidth: 400}}>
    ![](./images/Arduino-Example-11-4.webp)
  </div>
...
- Swipe left to enter the AMOLED backlight setting interface, as shown:
  ...
  <div style={{maxWidth: 800}}>
    ![](./images/Arduino-Example-11-5.webp)
  </div> 
