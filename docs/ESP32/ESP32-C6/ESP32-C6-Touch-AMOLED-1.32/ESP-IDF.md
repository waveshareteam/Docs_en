...
slug: /ESP32-C6-Touch-AMOLED-1.32/Development-Environment-Setup-ESP-IDF
product_family:
  - ESP32
product_model:
...
Please refer to **[Install ESP-IDF Development Environment](/docs/ESP32/Tutorials/ESP-IDF-Tutorials/01-Setup.md#esp-idf-setup)**.

:::info
For the ESP32-C6-Touch-AMOLED-1.32 development board, ESP-IDF version 5.5.0 or above is required.
:::
...
- Click the BOOT button again to exit the backlight control interface, then click the PWR button to enter the Touch interface, as shown in the figure:
  ...
  :::note
  1. Display the touch coordinates on the screen
  :::
