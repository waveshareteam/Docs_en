...
slug: /ESP32-S3-Touch-LCD-3.49/Development-Environment-Setup-Arduino
product_family:
  - ESP32
product_model:
...
- The sample program package for the ESP32-S3-Touch-LCD-3.49 development board can be downloaded from [here](./Resources-And-Documents.md#Demo). The <code>Arduino\libraries</code> directory within the package already includes all the library files required for this tutorial.
...
import esp32S3TouchLCD3_49ArduinoToolCfg from './images/ESP32-S3-Touch-LCD-3.49-ArduinoToolCfg.webp';

<div 
    style={{maxWidth:600}}> 
    <img 
        src={esp32S3TouchLCD3_49ArduinoToolCfg} 
    />
</div>
