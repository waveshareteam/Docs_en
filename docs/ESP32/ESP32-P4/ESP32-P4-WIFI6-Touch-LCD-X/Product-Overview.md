---
sidebar_position: 1
title: ESP32-P4-WIFI6-Touch-LCD-X
slug: /ESP32-P4-WIFI6-Touch-LCD-X
id: ESP32-P4-WIFI6-Touch-LCD-X-Overview
product_family:
  - ESP32
product_model:
...
- Memory
  ...
  - Stacked 32MB PSRAM within the chip package, and externally integrated 32MB Nor Flash.
- Peripheral Interfaces
  - Onboard peripherals including MIPI-CSI, MIPI-DSI, USB 2.0 OTG, an SDIO 3.0 TF card slot, dual microphones (supports echo cancellation), and speaker, etc.

## Hardware Description

![ESP32-P4-WIFI6-Touch-LCD-X Hardware Description 1](https://www.waveshare.net/w/upload/thumb/3/3e/ESP32-P4-WIFI6-Touch-LCD-7-details-intro.jpg/600px-ESP32-P4-WIFI6-Touch-LCD-7-details-intro.jpg)

1. **ESP32-P4-Core** Integrates ESP32-P4NRW32 and 32MB Nor Flash
2. **ESP32-C6-MINI-1U-H8 module** SDIO interface protocol, extending Wi-Fi 6 / Bluetooth 5 (LE)
3. **MIPI CSI interface** 15PIN pitch 1.0mm interface for connecting MIPI-2lane camera
4. **2.54mm 4PIN pads** Used for ESP32-C6 module firmware flashing
5. **Speaker header** 1.25mm 2PIN
6. **Touch panel connector** Supports touch function expansion
7. **DSI display connector** Used for connecting display devices and data transmission
8. **ES8311 low-power audio codec chip** Handles audio encoding and decoding tasks
9. **ES7210 Echo cancellation algorithm chip** Effectively eliminates echo and improves audio capture accuracy
10. **TF card slot** Utilizes the SDIO 3.0 interface protocol, supporting storage expansion
11. **Battery header** A JST 2Pin connector with 1.2mm pitch, suitable for external battery power supply
12. **Board-to-Board signal transmission interfaces** Designed for a 16Pin 0.5mm pitch FPC cable, enabling signal communication between boards
13. **Board-to-Board power supply & common ground interfaces** Designed for an ultra-thin 1.25mm 4Pin header cable, ensuring stable power and common ground connection
14. **Onboard microphones** Features a dual-microphone array design, optimizing audio capture performance
15. **USB TO UART Type-C port** Provides power supply, firmware flashing, and debugging capabilities
16. **USB OTG Type-C port** A USB OTG 2.0 High-Speed interface supporting peripheral expansion
17. **Power supply ON/OFF switch** Controls the device's power on/off state.
18. **BOOT button** Presses it when powering on or resetting to enter download mode
19. **RESET button** Used for device reset operations
20. **PWR & Charge dual-color indicator** Serve as a power indicator and a charging indicator, visually displaying device status
21. **40PIN header** Provides a general-purpose expansion interface, supporting connection of various peripherals and function expansion

## Pinout Definition

![ESP32-P4-WIFI6-Touch-LCD-X Pinout Definition](https://www.waveshare.net/w/upload/thumb/c/c1/ESP32-P4-WIFI6-Touch-LCD-7-details-intro-1.jpg/600px-ESP32-P4-WIFI6-Touch-LCD-7-details-intro-1.jpg)

## Dimensions
### ESP32-P4-WIFI6-Touch-LCD-7
![ESP32-P4-WIFI6-Touch-LCD-7 Product Dimensions](https://www.waveshare.net/w/upload/thumb/1/17/ESP32-P4-WIFI6-Touch-LCD-7-details-size.jpg/600px-ESP32-P4-WIFI6-Touch-LCD-7-details-size.jpg)
### ESP32-P4-WIFI6-Touch-LCD-8
![ESP32-P4-WIFI6-Touch-LCD-8 Product Dimensions](https://www.waveshare.net/w/upload/thumb/7/76/ESP32-P4-WIFI6-Touch-LCD-8-details-size.jpg/600px-ESP32-P4-WIFI6-Touch-LCD-8-details-size.jpg)

### ESP32-P4-WIFI6-Touch-LCD-10.1
![ESP32-P4-WIFI6-Touch-LCD-10.1 Product Dimensions](https://www.waveshare.net/w/upload/thumb/f/f7/ESP32-P4-WIFI6-Touch-LCD-10.1-details-size.jpg/600px-ESP32-P4-WIFI6-Touch-LCD-10.1-details-size.jpg)
