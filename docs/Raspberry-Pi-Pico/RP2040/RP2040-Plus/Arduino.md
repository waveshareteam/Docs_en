...
1. The RP2040-Plus can be selected directly within the Arduino IDE. Choose "Waveshare RP2040-Plus".
    ...
    ![Selecting RP2040-Plus in Arduino IDE](./images/ArduinoIDE-RP2040-Plus.webp)
    </div>

2. After selecting the development board, you can refer to the [Arduino Getting Started Tutorial](../../Tutorials/Arduino-Tutorials/index.md#5-First-Program-Upload) to upload your program.