...
The RP2350-Touch-AMOLED-1.75 supports three development frameworks: MicroPython, VSCode, and Arduino, providing developers with flexible choices. You can select the appropriate development tool based on project requirements and personal preference.

Each of the three development methods has its own advantages. Developers can choose based on their needs and skill level. MicroPython is simple to learn and quick to get started with, suitable for beginners and non-professionals. Arduino and VSCode provide more advanced development tools and stronger control capabilities, suitable for developers with a professional background or higher performance requirements, and are more suitable for complex project development.

- **Thonny IDE** is a lightweight Python Integrated Development Environment designed for beginners, originally created for teaching scenarios and now widely used for MicroPython / CircuitPython development, especially suitable for microcontrollers like Raspberry Pi Pico. Thonny has a clean interface, a built-in Python interpreter, supports serial REPL, code flashing, and debugging, and has a simple configuration process, making it very suitable for quickly getting started with embedded Python development. You can refer to the **[Working with Thonny IDE](./Thonny.md)** to complete the initial setup. The tutorial also provides related demos for reference.

- **VSCode** is a cross-platform, lightweight code editor that does not inherently include a compiler or toolchain. By installing the Pico VSCode extension, you can build a complete development environment. This extension integrates the toolchain required for the Pico SDK, the CMake build system, and flashing/debugging tools, supporting development based on C/C++ and MicroPython. Developers can operate through a graphical interface for efficient project development and debugging. Therefore, we recommend using the Pico VSCode extension for development. The specific configuration process can be found in the **[Working with VSCode](./VSCode.md)**, which also provides relevant example programs for reference.

- **Arduino IDE** is a convenient, flexible, and easy-to-use open-source electronics prototyping platform. It requires minimal foundational knowledge, allowing for rapid development after a short learning period. Arduino has a vast global community that provides a wealth of open-source code, project examples, tutorials, and rich libraries that encapsulate complex functionalities, enabling developers to implement various features quickly. You can refer to the **[Working with Arduino IDE](./Arduino.md)** to complete the initial setup, and the tutorial also provides related demos for reference.
