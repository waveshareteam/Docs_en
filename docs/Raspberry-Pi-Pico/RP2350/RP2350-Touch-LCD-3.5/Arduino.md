...
slug: /RP2350-Touch-LCD-3.5/Arduino
...
1. Install the LVGL Library
    <div style={{maxWidth:600}}> 
    ![Arduino-Example-1](./images/Arduino-Example-1.webp)
    </div>
    1. Click on the third icon in the left sidebar or click on "Tools">"Manage Library..." in the menu bar <br />
    2. Enter "lvgl" in the search box and find the "lvgl" library.<br />
    3. Select version 8.2.0.<br />
    4. Click the "INSTALL" button to install it.

2. Add Configuration File
    <div style={{maxWidth:600}}> 
    ![Arduino-Example-2](./images/Arduino-Example-2.webp)
    </div>
    1. LVGL has its own configuration file named `lv_conf.h`.<br />
    2. Go to the directory of the installed Arduino libraries. Here you can see the directory of the lvgl library we installed.<br />
    3. Download the program package and copy `Arduino\lv_conf.h` from the package to your local Arduino library directory.<br />
    4. The final `lv_conf.h` layout should look like this:
    ```
    arduino
        |-libraries
            |-lvgl
...
- LVGL Widget Alignment and Positioning
    ...
    ```
    <div style={{maxWidth:800}}> 
    ![VSCode-Example-7](./images/VSCode-Example-7.webp)
    </div>
...
- Use VS Code to import and compile the 05_LVGL project. After compilation is complete, flash the uf2 file in the `build` directory, or directly flash the 05_LVGL.uf2 file in the `uf2` directory for quick verification.
    ...
    <div style={{maxWidth:400}}> 
    ![VSCode-Example-8](./images/VSCode-Example-8.webp)
    </div>